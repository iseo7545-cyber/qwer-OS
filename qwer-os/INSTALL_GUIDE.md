...
Run the script to start building qwer OS. Go take a dump — this is gonna take a while probably.
bashchmod +x scripts/build_iso.sh
chmod +x src/ilo.sh
...
bashcp ~/qwer-os/build/qwer-os.iso /mnt/qwer_os/
Step 5: Installation
